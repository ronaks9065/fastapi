...
async def authenticate_user(auth_request: AuthRequest):
    ...
    """
    try:
        # Use CognitoAuth to authenticate user
        auth_response = cognito_auth.authenticate_user(
        ...
        # # Step 4: Validate the Access Token TBD
        # decoded_access_token = cognito_auth.verify_access_token(access_token)
        # print("Access Token validated successfully:", decoded_access_token)

        # Step 3: Return the authentication response
        return {
            "status": "success",
...
def login_access_token(
    ...
    # Local authentication with the database
